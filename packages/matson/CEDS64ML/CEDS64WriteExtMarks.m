...
%   Markers - A vector of 64-bit integers (marker times in ticks)
%   Outputs - 0 if the writing was successful otherwise a negative error
%   code
...
switch (rType)
    ...
    case 7 % writing to a real channel
...
for n=1:N
    ...
    Data = reshape(vMarkers(n).m_Data, [], 1 );
    nSize = length(Data);
