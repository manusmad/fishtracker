...
%CEDS64CHANSCALE Gets and sets the scale for a channel
%   [ iOk, dScaleOut ] = CEDS64ChanScale( fhand, iChan, dScaleIn )
%   [ iOk ] = CED64SetChanScale( fhand, iChan, dRate )
%   fhand - An integer handle to an open file
%   iChan - A channel number
%   dScaleIn - (Optional) The new scale as a double
%   Output
%   iOk - 0 if the scale was set correctly otherwise a negative error code
