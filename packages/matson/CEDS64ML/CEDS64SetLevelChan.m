...
function [ iOk ] = CEDS64SetLevelChan( fhand, iChan, dRate )
%CEDS64SETLEVELCHAN Creates a new event channel
...
iOk = calllib('ceds64int', 'S64SetLevelChan', fhand, iChan, dRate );
