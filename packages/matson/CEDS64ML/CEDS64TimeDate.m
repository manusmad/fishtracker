...
%CEDS64TIMEDATE Gets and sets the time and date saved in a file (usually the time that sampling began) Note this is not the same format as MATLAB's clock function
%   [ iOk, TimeDateOut ] = CEDS64TimeDate( fhand, TimeDateIn )
%   Inputs
%   fhand - Integer file handle
%   TimeDateIn - The new time date as a 7-by-1 vector
%   Outputs
