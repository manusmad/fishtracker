...
%   [ iOk, dTBaseOut ] = CEDS64TimeBase( fhand, dTBaseIn )
%   Inputs
%   fhand - An integer handle to an open file
%   dTBaseIn - The new time base as a double
%   Outputs
%   iOk - 0 if the time base was set correctly, otherwise a negative error
%   code.
%   dTBaseIn - The old time base as a double
